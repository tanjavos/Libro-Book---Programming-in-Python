...
Aquí, \pythoninline{expr} es cualquier expresión válida que devuelva un valor, \pythoninline{val} es una variable que representa cada valor en la coleccion \pythoninline{collection}.
...
La expresión condicional \pythoninline{condition} se evalúa para cada elemento en la \pythoninline{collection} y, si es True, se agrega \pythoninline{exp} a la lista resultante.
...
\begin{python}
[ expr1  if condition else  expr2  for val in collection ]
\end{python}

La expresión condicional \pythoninline{condition} se evalúa para cada elemento in \pythoninline{collection} y, si es True, se agrega \pythoninline{expr1} a la lista resultante, de lo contrario, se agrega \pythoninline{expr2}.
